...
import {
  fetchVolumeFormaPagamento,
  type VolumeFormaPagamentoFiltros,
} from "@/lib/queries/comercial/volume-forma-pagamento-extract";
...
export async function GET(request: Request) {
  ...
  const filtros: VolumeFormaPagamentoFiltros = {
    dataInicio,
    dataFim,
  ...
  try {
    const rows = await fetchVolumeFormaPagamento(filtros);
