...
import {
  fetchValorFormaPagamento,
  type ValorFormaPagamentoFiltros,
} from "@/lib/queries/comercial/valor-forma-pagamento-extract";
...
export async function GET(request: Request) {
  ...
  const filtros: ValorFormaPagamentoFiltros = {
    dataInicio,
    dataFim,
  ...
  try {
    const rows = await fetchValorFormaPagamento(filtros);
